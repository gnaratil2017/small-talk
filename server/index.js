...
const newsVotes = require('./routes/news-votes')
const youtubeVotes = require('./routes/youtube-votes')
const twitterVotes = require('./routes/twitter-votes')
...
app.use('/api/news-votes', newsVotes)
app.use('/api/youtube-votes', youtubeVotes)
